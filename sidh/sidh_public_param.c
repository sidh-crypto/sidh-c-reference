...
void sidh_public_params_init(public_params_t params) {
    ...
    sidh_elliptic_curve_init(params->E);
    sidh_point_init(params->P);
    sidh_point_init(params->Q);
    mpz_init(params->le);
}
...
void sidh_public_params_clear(public_params_t params) {
    mpz_clear(params->characteristic);
    sidh_elliptic_curve_clear(params->E);
    sidh_point_clear(params->P);
    sidh_point_clear(params->Q);
    mpz_clear(params->le);
}